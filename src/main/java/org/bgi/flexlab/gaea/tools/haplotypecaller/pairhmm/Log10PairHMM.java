...
import static org.bgi.flexlab.gaea.tools.haplotypecaller.pairhmm.PairHMMModel.*;
...
public final class Log10PairHMM extends N2MemoryPairHMM {
    ...
    private double myLog10SumLog10(final double[] values) {
        return doExactLog10 ? GvcfMathUtils.log10SumLog10(values) : GvcfMathUtils.approximateLog10SumLog10(values);
    }
