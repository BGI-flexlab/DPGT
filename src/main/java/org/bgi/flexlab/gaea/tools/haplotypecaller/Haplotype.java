...
public final class Haplotype extends Allele {
    ...
    public Haplotype trim(final Locatable loc) {
        ...
        Utils.validateArg(new GenomeLocation(genomeLocation).contains(loc), () -> "Can only trim a Haplotype to a containing span.  My loc is " + genomeLocation + " but wanted trim to " + loc);
