...
public abstract class RankSumTest extends InfoFieldAnnotation {
    ...
    public Map<String, Object> annotate(final ChromosomeInformationShare ref,
        ...
        if( likelihoods != null) {
            for (final ReadLikelihoods<Allele>.BestAllele bestAllele : likelihoods.bestAlleles()) {
                final GaeaSamRecord read = bestAllele.read;
     ...
     */
    protected OptionalDouble getElementForRead(final GaeaSamRecord read, final int refLoc, ReadLikelihoods<Allele>.BestAllele bestAllele) {
     ...
     */
    protected abstract OptionalDouble getElementForRead(final GaeaSamRecord read, final int refLoc);
     ...
     */
    protected boolean isUsableRead(final GaeaSamRecord read, final int refLoc) {
        Utils.nonNull(read);
