...
public final class GenotypeUtils {
    ...
    public static GenotypeCounts computeDiploidGenotypeCounts(final VariantContext vc, final GenotypesContext genotypes,
        ...
        for (final Genotype g : genotypes) {
            ...
            final double[] normalizedLikelihoods = GvcfMathUtils.normalizeFromLog10ToLinearSpace(g.getLikelihoods().getAsVector());
            ...
            if( roundContributionFromEachGenotype ) {
                refCount += GvcfMathUtils.fastRound(normalizedLikelihoods[idxAA]);
                hetCount += GvcfMathUtils.fastRound(normalizedLikelihoods[idxAB]);
                homCount += GvcfMathUtils.fastRound(normalizedLikelihoods[idxBB]);
            } else {
