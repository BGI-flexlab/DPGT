...
public class Tranche {
    ...
    public Tranche(final String name, final double knownTiTv, final int numNovel, final double minVQSLod, final VCFQualityControlArgumentCollection.Mode model, final double novelTiTv, final int accessibleTruthSites, final int numKnown, final int callsAtTruthSites) {
    ...
    protected static Tranche trancheOfVariants(final List<VariantDatum> data, final int minI, final double ts, final VCFQualityControlArgumentCollection.Mode model ) {
    ...
    protected static Tranche emptyTranche(final List<VariantDatum> data, final int minI, final double ts, final VCFQualityControlArgumentCollection.Mode model ) {
    ...
    protected static double getRequiredDouble(final Map<String, String> bindings, final String key) {
        if ( bindings.containsKey(key) ) {
            try {
                ...
                throw new MalformedFile("Malformed tranches file. Invalid value for key " + key);
            }
        } else  {
